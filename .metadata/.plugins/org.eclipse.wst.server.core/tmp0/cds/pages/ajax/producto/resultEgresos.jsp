<%@ include file="/pages/template/taglibs.jsp" %>
	...
	<div class="displayTable">
		<display:table id="data" name="listaVenta" requestURI="/egresoProducto_search.do" pagesize="10" export="true" class="table table-striped table-condensed" excludedParams="*">
			...
			<display:column property="formaDePago.nombre" title="Forma de pago"/>
	...
	<s:if test="%{listaVenta!=null}">
		<h3 class="text-right"><strong>Total Ventas:$<s:property value="totalVentaDiaria"/></strong></h3>
	</s:if>
